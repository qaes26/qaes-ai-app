document.addEventListener('DOMContentLoaded', () => {
    ...
    // ✨ التعديل النهائي والمهم هنا: تم وضع رابط موقعك على الإنترنت ✨
    const BACKEND_URL = 'https://qaes-ai-app.onrender.com';
    
    let attachedFile = null;

    // --- وظيفة مساعدة لتغيير حجم مربع النص ---
    const adjustTextareaHeight = () => { 
        userInput.style.height = 'auto'; 
        userInput.style.height = (userInput.scrollHeight) + 'px'; 
    };
    
    // --- وظيفة إضافة الرسائل مع قدرة إنشاء PDF حقيقي ---
    ...
    // --- وظيفة عرض معلومات الملف المرفق ---
